//LEGACY hook. not documented 
//used to load script instead of map?
void LoadMap()
{
	RegisterFileExtensionScript("Scripts/MapLoaders/LoadPNGMap.as", "png");

	//load kaggen.cfg extensions in GenerateFromKAGGen.as
	//RegisterFileExtensionScript("Scripts/MapLoaders/GenerateFromKAGGen.as", "kaggen.cfg");
	RegisterFileExtensionScript("ProceduralMapGen.as", "kaggen.cfg");

	LoadRules("Sandbox/gamemode.cfg");
